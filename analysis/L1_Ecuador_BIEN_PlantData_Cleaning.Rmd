...
query_names <- bdc_query_names_taxadb(
  ...
  ncores              = 4, # number of cores to be used in the parallelization process
...
output <- output[ , c("scientificName", "decimalLatitude", "decimalLongitude", "verbatimEventDate", "year", "vertbatimElevation")]
```
